...
frag_df_full_glad$driverName[frag_df_full_glad$Driver_2023==1] <- "Deforestation"
frag_df_full_glad$driverName[frag_df_full_glad$Driver_2023==2] <- "Shifting Agriculture"
frag_df_full_glad$driverName[frag_df_full_glad$Driver_2023==3] <- "Forestry"
frag_df_full_glad$driverName[frag_df_full_glad$Driver_2023==4] <- "Wildfire"
frag_df_full_glad$driverName[frag_df_full_glad$Driver_2023==5] <- "Urbanization"
...
frag_df_full_glad_CFI$driverName[is.na((frag_df_full_glad_CFI$driverName))] <- "Zero or Minor Cover Loss"
...
AA <- frag_df_full_glad_aggregate[frag_df_full_glad_aggregate$Mega_Biome=="Global",]
Area_Sum <- sum(AA$RegionArea[c(1, 2, 4, 5, 6)])
AA$RegionArea/Area_Sum

BB <- frag_df_full_glad_aggregate[frag_df_full_glad_aggregate$Mega_Biome=="Tropical",]
Area_Sum <- sum(BB$RegionArea[c(1, 2, 4, 5, 6)])
BB$RegionArea/Area_Sum

CC <- frag_df_full_glad_aggregate[frag_df_full_glad_aggregate$Mega_Biome=="Temperate",]
Area_Sum <- sum(CC$RegionArea[c(1, 2, 4, 5, 6)])
CC$RegionArea/Area_Sum

DD <- frag_df_full_glad_aggregate[frag_df_full_glad_aggregate$Mega_Biome=="Boreal",]
Area_Sum <- sum(DD$RegionArea[c(1, 2, 4, 5, 6)])
DD$RegionArea/Area_Sum

ggsave("C:/Zeus/ETHz/ETHz_S5/Forest_FRAG/Results/Week32_2024.6.3/Figure4_2023.pdf", plot=Fig4A, width=9, height=6)
